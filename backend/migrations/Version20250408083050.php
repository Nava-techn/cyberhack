 ...
 */
final class Version20250408083050 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maitredejeu (Id_MaitreDeJeu INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Id_Secteur INT NOT NULL, Id_Pirate INT NOT NULL, Id_Jeux INT NOT NULL, UNIQUE INDEX Id_Secteur (Id_Secteur), INDEX Id_Pirate (Id_Pirate), INDEX Id_Jeux (Id_Jeux), PRIMARY KEY(Id_MaitreDeJeu)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
