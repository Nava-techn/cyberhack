 ...
 */
final class Version20250408083541 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maitredejeu (Id_MaitreDeJeu INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Id_Secteur INT NOT NULL, Id_Pirate INT NOT NULL, Id_Jeux INT NOT NULL, INDEX Id_Jeux (Id_Jeux), UNIQUE INDEX Id_Secteur (Id_Secteur), INDEX Id_Pirate (Id_Pirate), PRIMARY KEY(Id_MaitreDeJeu)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE rassembler (Id_Pochette INT NOT NULL, Id_Bouclier INT NOT NULL, Id_Evenement INT NOT NULL, Id_Jeux INT NOT NULL, INDEX Id_Jeux (Id_Jeux), INDEX Id_Bouclier (Id_Bouclier), INDEX Id_Evenement (Id_Evenement), INDEX IDX_EA895BDA9514DC01 (Id_Pochette), PRIMARY KEY(Id_Pochette, Id_Bouclier, Id_Evenement, Id_Jeux)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
