 ...
 */
class getEventCardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventCardRepository' shared autowired service.
     *
     * @return \App\Repository\EventCardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventCardRepository.php';

        return $container->privates['App\\Repository\\EventCardRepository'] = new \App\Repository\EventCardRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
